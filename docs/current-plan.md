...
高速開発モードP0/P2の最小前進として、7年代をデータモデルと開始画面の選択肢へ追加した。今回レビュー済みの代表サンプルは幼稚園・中学生・社会人のみで、各年代へ新規1場面ずつを追加した。他4年代は「開発中」と明示して開始不可にし、未完成を隠さない。既存5場面は社会人プールとして維持し、電車操作・採点値・PixiJS統合箇所は変更していない。次のコンテンツサイクルでは、代表3年代のいずれか1年代だけに少量追加し、「複数シチュエーション」の未達を減らす。
