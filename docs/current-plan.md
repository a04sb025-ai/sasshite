...
高速開発モードP0/P2の最小前進として、7年代をデータモデルと開始画面の選択肢へ追加した。レビュー済みの代表サンプルは幼稚園・中学生・社会人のみで、幼稚園は積み木の共有と、ひとりで見ている子の遊びへの迎え方を扱う2場面になった。中学生は1場面、社会人は既存5場面と1場面の代表サンプルを持つ。他4年代は「開発中」と明示して開始不可にし、未完成を隠さない。電車操作・既存場面の採点値・PixiJS統合箇所は変更していない。次のコンテンツサイクルでは、代表サンプルの中学生に少量追加し、「複数シチュエーション」の未達を減らす。
